...
if(request.getParameter("op")!=null)
{
	...
	{
		int nb = Integer.parseInt(request.getParameter("id"));
		um.updateUser(nb,ut);
	}
      ...
      <div class="container-fluid">
        ...
        <div class="col-md-4">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-header text-white" style="background: url('dist/img/greyuser.png') center center; size:30px;">
                <h3 class="widget-user-username text-right"><%=u.getLog() %></h3>
                <h5 class="widget-user-desc text-right"><%=u.getRole() %></h5>
              </div>
        ...
        <%} %>
          ...
          <form action="Users" method="post"><button type="submit" class="btn btn-secondary btn-lg"><i class="far fa-plus-square" ></i>Add User</button></form>
